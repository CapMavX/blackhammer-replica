...
const   MNavbar = () => {
  return (
    <nav className=' max-w-fit h-[80px] mt-[26px] ml-[39px]  rounded-2xl bg-white flex' id='Dashboard'>
        <div className='max-w-fit h-[Hug (47px)] mt-[16px] ml-[16px] gap-[10px]'><h1 className='w-[123px] h-[21px] font-[Inter] font-semibold text-base leading-5 text-black'>Miners (300)</h1><h2 className='w-[265px] h-[16px] font-[Inter] font-normal italic text-xs leading-4 text-gray-600'>Good Evening - Sunday, 1 September 2023</h2></div>
