  ...
  return (
    <div className='max-w-[950px] max-h-screen mt-[29px] ml-[39px] rounded-[13px]  bg-white'>
        <section className='flex'>
         <h1 className='w-[163px] h-[21px] mt-[23px] ml-[23px] font-[Inter] font-semibold text-[17px] leading-[20.57px] text-[#130F26]'>List of Miners (800)</h1>
        <p className='w-[54px] h-[21px] mt-[23px] ml-[650px] font-[Inter] font-medium text-[17px] leading-[20.57px] text-[#168DE2]  '>See all</p>
       </section>
      <div className='w-[950px] h-[514px] mt-[24px] ml-[24px] mr-[24px] gap-[36px]  '>
       ...
       <div className='w-[Hug (182px)] h-[Hug (41px)] gap-[10px]   flex'>
           <div className='w-[182px] h-[41px] rounded-[12px] bg-[#168DE2] ml-[450px]'>
            <div className='w-[Hug (128px)] h-[Hug (20px)] mt-[11px] ml-[27px] gap-[12px] flex'>
                ...
                <div className='w-[96px] h-[16px] text-white mt-[-5px]'><a href='/Miners' className='w-[196px] h-[16px] mt-[-2px] ml-[2px] text-[13px]'>Add New Miner</a> </div>
            </div>
            </div> 
       </div>
